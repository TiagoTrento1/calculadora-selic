...
tabela_acumulada = None

if st.button("Carregar e Calcular SELIC acumulada"):
...
# Botão opcional para visualizar a tabela
if st.button("Mostrar tabela SELIC acumulada"):
    if tabela_acumulada is not None:
        st.subheader("Tabela SELIC acumulada:")
        st.dataframe(tabela_acumulada)
    else:
        st.warning("Carregue primeiro a tabela clicando em 'Carregar e Calcular SELIC acumulada'.")

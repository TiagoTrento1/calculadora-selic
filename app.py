    ...
    with st.spinner('Buscando dados e calculando...'):
        ...
        if tabela_mensal is not None:
            ...
            if total_taxa is not None and total_taxa > 0:
                ...
                # Métrica customizada com fundo branco e valor em reais maior
                valor_html = f"""
                <div style="
                    background: #ffffff;
                    padding: 24px;
                    ...
                    text-align: center;
                ">
                    <div style="font-size: 1.7em; font-weight: 700; color: #0033A0; margin-bottom:8px;">
                        Valor Corrigido (R$):
                    </div>
                    <div style="font-size: 4.8em; font-weight: 800; color: #D52B1E; line-height:1;">
